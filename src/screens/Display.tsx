...
export default function DisplayScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#f9fafb" }}>
      ...
      <View className="bg-white border-b border-gray-200">
        ...
        >
          ...
          <IconButton
            ...
            size={24}
            onPress={() => {
              (navigation.navigate as any)('HomePage', { newQueue: createQueueData() });
            }}
            iconColor="#000"
      ...
      <ScrollView
        style={{ flex: 1 }}
        contentContainerStyle={{ padding: 24, alignItems: "center", paddingBottom: 32 }}
      ...
      >
        ...
        <View style={{ width: "100%", gap: 12 }}>
          <Button
            mode="contained"
            onPress={() => {
              (navigation.navigate as any)('MyQueues', { newQueue: createQueueData() });
            }}
            style={{
